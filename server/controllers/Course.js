...
exports.editCourse = async (req, res) => {
	try {
        ...
        const updatesPlain = Object.fromEntries(Object.entries(updates));
		...
		for (const key in updatesPlain) {
			if (Object.prototype.hasOwnProperty.call(updatesPlain, key)) {
			  if (key === "tag" || key === "instructions") {
				course[key] = JSON.parse(updatesPlain[key]);
			  } else {
				course[key] = updatesPlain[key];
			  }
			}
		  }
